<x-layouts.guest :title="__('app.notfound_title')">
    <div class="card blueprint" style="padding:32px 24px;gap:14px;align-items:center;text-align:center;">
        ...
        <h1 style="margin:0;font-family:var(--font-heading);font-size:24px;">{{ __('app.notfound_title') }}</h1>
        <p class="sq-mute" style="margin:0;font-size:14px;max-width:40ch;">{{ __('app.notfound_body') }}</p>
